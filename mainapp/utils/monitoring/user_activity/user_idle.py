...
class UserIdle(EventHandler):
    _EVENT_TYPE = MonitorEvents.EVENT_USER_IDLE
    ...
    def _log_event(self):
        logger.info(
            f"User {self.__user.display_name} from org {self.__user.organization.name} is idle now"
        )
