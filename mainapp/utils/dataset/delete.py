...
def delete_aws_resources_for_dataset(dataset, org_name):
    try:
        __delete_dataset_bucket(dataset, org_name)
        __delete_dataset_role_and_policy(dataset, org_name)
        __delete_dataset_glue_database(dataset, org_name)
...
def __delete_dataset_role_and_policy(dataset, org_name):
...
def __delete_dataset_bucket(dataset, org_name):
    logger.info(
...
def __delete_dataset_glue_database(dataset, org_name):
