...
urlpatterns = [
    ...
    url(r'^access_requests/response_access_request_for_dataset/(?P<dataset_id>[^/]+)$', views.HandleDatasetAccessRequest.as_view(), name='response_full_access_request_for_dataset'),
