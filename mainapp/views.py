...
class CreateCohort(GenericAPIView):
    ...
    def post(self, request):
        ...
        if query_serialized.is_valid():
            ...
            ctas_query = 'CREATE TABLE "'+data_source.dataset.glue_database+'"."'+data_source.glue_table+'"'+" WITH (format = 'TEXTFILE', external_location = 's3://"+destination_dataset.bucket+"/"+data_source.glue_table+"/') AS "+query+";"
